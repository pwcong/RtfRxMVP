...
public class PushMsgService extends Service {
    ...
    public void onCreate() {
        ...
        subscribe = Observable.timer(delay, delay, TimeUnit.HOURS, Schedulers.newThread())
    ...
    private void pushWeatherMsg() {
        ...
        service.getWeather(SharedPreferencesManager.getInstance().getString(Constants.CITY_NAME, "深圳"), Api.KEY_WEATHER,
                    ...
                    public void onNext(WeatherBean weatherBean) {
                        ...
                        if (weatherBean.getError_code() == 0) {
                            ...
                            Notification notification = new Notification.Builder(PushMsgService.this)
                                    ...
                                    .setContentText(realtime.getWeather().getInfo() + "，当前温度为 "
