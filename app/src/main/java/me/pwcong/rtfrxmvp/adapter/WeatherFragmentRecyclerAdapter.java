...
public class WeatherFragmentRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case Constants.TAG_HEADER:
                View view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_weather_header, parent,
                        false);
                return new WeatherHeaderItemViewHolder(view1);
            case Constants.TAG_DIVIDER_1:
                View view2 = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_text_divider, parent,
                        false);
                return new TextDividerViewHolder(view2);
            case Constants.TAG_RECYCLER_VERTICAL:
                View view3 = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recycler_vertical, parent,
                        false);
                return new RecyclerItemViewHolder(view3);
            case Constants.TAG_DIVIDER_2:
                View view4 = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_text_divider, parent,
                        false);
                return new TextDividerViewHolder(view4);
            case Constants.TAG_RECYCLER_HORIZONTAL:
                View view5 = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recycler_horizontal, parent,
                        false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            case Constants.TAG_RECYCLER_VERTICAL:
                ...
                ((RecyclerItemViewHolder) holder).bindData(verticalLayoutManager,
                        new WeatherItemRecyclerAdapter(context, data.getWeather()),
                        new RecyclerViewDivider(context, RecyclerViewDivider.VERTICAL_LIST));
            ...
            case Constants.TAG_RECYCLER_HORIZONTAL:
                ...
                ((RecyclerItemViewHolder) holder).bindData(horizontalLayoutManager,
                        new LifeItemRecyclerAdapter(context, getLifeInfoList(data.getLife().getInfo())),
                        new RecyclerViewDivider(context, RecyclerViewDivider.HORIZONTAL_LIST));
    ...
    public int getItemViewType(int position) {
        ...
        switch (position) {
            case 0:
                return Constants.TAG_HEADER;
            case 1:
                return Constants.TAG_DIVIDER_1;
            case 2:
                return Constants.TAG_RECYCLER_VERTICAL;
            case 3:
                return Constants.TAG_DIVIDER_2;
            case 4:
                return Constants.TAG_RECYCLER_HORIZONTAL;
        }
        ...
        public void bindData(Context context, WeatherBean.Data data) {
            ...
            if (weatherIconId > -1 && weatherIconId < 32) {
                Glide.with(context)
                        ...
                        .override((int) ResourceUtils.fromDimenResId(R.dimen.size_weather_img),
                                (int) ResourceUtils.fromDimenResId(R.dimen.size_weather_img))
                        .into(iv_weather);
            } else {
                Glide.with(context)
    ...
    public class RecyclerItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(LinearLayoutManager layoutManager, RecyclerView.Adapter adapter,
